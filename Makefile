...
test_time: $(CLASS_DIR)/time_test.cpp $(wildcard $(CLASS_DIR)/lib/*.cpp)
	$(CXX) $(CXXFLAGS) -o build/time_test_C.exe $(CLASS_DIR)/time_test.cpp $(wildcard $(CLASS_DIR)/lib/*.cpp)

test_class: $(CLASS_DIR)/class_test.cpp $(wildcard $(CLASS_DIR)/lib/*.cpp)
	$(CXX) $(CXXFLAGS) -o build/class_test_C.exe $(CLASS_DIR)/class_test.cpp $(wildcard $(CLASS_DIR)/lib/*.cpp)
